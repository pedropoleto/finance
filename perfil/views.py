...
def home(request):
    ...
    return render(request, 'home.html', {'contas': contas, 'total_conta': total_contas})
...
def gerenciar(request):
    ...
    total_contas = calcula_total(contas, 'valor')
    return render(request, 'gerenciar.html', {'contas': contas, 'total_conta': total_contas, 'categorias': categorias})
